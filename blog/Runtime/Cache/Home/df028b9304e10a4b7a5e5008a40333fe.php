  ...
  <div class="row">
    <!-- 左边内容 博文内容展示区 -->
  	...
  	<div class="col-md-3" style="margin: 10px 0;">
  	    <div class="row" style="margin: 15px 0 0 0;"><a class="btn btn-success btn-lg" href="<?php echo U('/Home/Upload/add_blog');?>" role="button" style="width: 100%;"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;说出心里话</a></div>
        ...
        <div class="col-md-12 Messagebook">
        	<h4>最热博文</h4>
        	<?php if(is_array($blog_info)): $i = 0; $__LIST__ = $blog_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('/Home/Upload/read_blog/blog_id/'.$v['blog_id']);?>" style="text-decoration: none;color: #000;">
        	<?php echo ($v["title"]); ?></a>
        	<span style="color: #6C6C6C"></span>&nbsp;&nbsp;<span class="badge"><?php echo ($v["visit_count"]); ?></span></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="col-md-12 Messagebook">
        	<h4>活跃博客</h4>
        	...
        	<?php echo ($v["user_name"]); ?>&nbsp;&nbsp;<span class="badge"><?php echo ($v["login_count"]); ?></span></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
  </div>
</div>
<div id="footer" style="height: 100px; color: #fff; background: #4D4D4D">
	<div class="col-md-10 col-md-offset-1" style="margin-top: 10px;">
		...
		<div class="col-md-3">
			...
			&nbsp;博文总数：<?php echo ($datainfo["blog_count"]); ?>
			</h5>
		</div>
		<div class="col-md-3">
			<h5>
			<span class="glyphicon glyphicon-eye-open"></span>
			&nbsp;阅读总量：<?php echo ($datainfo["comment_count"]); ?>
			</h5>
		</div>
		<div class="col-md-3">
			<h5>
			<span class="glyphicon glyphicon-user"></span>
			&nbsp;博客总数：<?php echo ($datainfo["user_count"]); ?>
			</h5>
		</div>
		<div class="col-md-3">
			<h5>
			<span class="glyphicon glyphicon-blackboard"></span>
			&nbsp;登陆次数：<?php echo ($datainfo["visitor_count"]); ?>
			</h5>
		</div>
		</div>
	</div>
	<div class="col-md-12" style="text-align: center;margin-top: 10px;">Copyright ©2016 情感说</div>
</div>
