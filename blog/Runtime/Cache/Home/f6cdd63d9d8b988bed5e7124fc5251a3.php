  ...
  <div class="row">
    <!-- 左边内容 博文内容展示区 -->
  	...
  	<div class="col-md-3" style="margin: 10px 0;">
        ...
        <div class="col-md-12 Messagebook">
        	<h4>最新访客</h4>
        	<?php if(is_array($visitor_info)): $i = 0; $__LIST__ = $visitor_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><img src="/thinkphp/blog/Public/<?php echo ($v["visitor_img"]); ?>" width="25px" height="25px">&nbsp;&nbsp;<b><?php echo ($v["visitor_name"]); ?></b></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="col-md-12 Messagebook">
        	<h4>推荐博文</h4>
