		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <?php if(!empty($_SESSION['user_name'])): ?><li style="width: 46px;height: 50px;">
	                	<img id="userimg" src="/thinkphp/shop/Public/<?php echo ($user_img); ?>">
	                </li>
	           		<li class="dropdown">
  ...
  <div class="row">
    <!-- 左边内容 博文内容展示区 -->
  	<div class="col-md-9" id="blogcontent"> 
  	    <?php if(is_array($blog_info)): $i = 0; $__LIST__ = $blog_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="bloglist row">
	  			...
	  			<div class="col-md-12">
		  			<div class="col-md-3">
			  			<img src="/thinkphp/shop/Public/<?php echo ($v["blog_small_img"]); ?>" width="150px" height="120px">
		  			</div>
		  			<div class="col-md-9" style="color: #6C6C6C"><?php echo ($v["content"]); ?>
		  			</div>
	  			</div>
	  			<div class="col-md-12" style="margin: 5px 0;color: #6C6C6C">
	  				<div class="col-md-3">
	  				    <img src="/thinkphp/shop/Public/<?php echo ($v["author_img"]); ?>" width="25px" height="25px">&nbsp;&nbsp;<?php echo ($v["author"]); ?>
	  				</div>
	  				<div class="col-md-3">
	  			...
	  			<div class="col-md-12">
	  				<div class="col-md-12">
                        <?php if(is_array($comment_info)): $i = 0; $__LIST__ = $comment_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><p><?php echo ($a["comment"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
	  				</div>
	  				<div class="col-md-12">我要评论</div>
	  				<div class="col-md-12">
	  					<form action="<?php echo U('/Home/Upload/comment');?>" method="post" class="form-horizontal" role="form">
			        	<textarea class="form-control" name="comment" rows="3" placeholder="请输入评论" style="margin-top: 10px;"></textarea>
  	...
  	<div class="col-md-3" style="margin: 10px 0;">
        ...
        <div class="col-md-12 Messagebook">
        	<h4>留言板</h4>
        	<div id="messagelist">
        	<?php if(is_array($messageinfo)): $i = 0; $__LIST__ = $messageinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><img src="/thinkphp/shop/Public/<?php echo ($v["user_img"]); ?>" width="25px" height="25px">&nbsp;&nbsp;<b><?php echo ($v["user_name"]); ?></b></p>
        	...
        	<textarea class="form-control" name="message" rows="3" placeholder="请输入留言" style="margin-top: 10px;"></textarea>
        	<input type="submit" class="btn btn-default" value="留言" id="messagesubmit">
        	</form>
        </div>
        <div class="col-md-12 Messagebook">
        	<h4>最新访客</h4>
        	<?php if(is_array($visitor_info)): $i = 0; $__LIST__ = $visitor_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><img src="/thinkphp/shop/Public/<?php echo ($v["visitor_img"]); ?>" width="25px" height="25px">&nbsp;&nbsp;<b><?php echo ($v["visitor_name"]); ?></b></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="col-md-12 Messagebook">
        	<h4>推荐博文</h4>
        	<?php if(is_array($blog_info)): $i = 0; $__LIST__ = $blog_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><b><?php echo ($v["title"]); ?></b><span style="color: #6C6C6C">[<?php echo ($v["cat"]); ?>]</span></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
  </div>
</div>
