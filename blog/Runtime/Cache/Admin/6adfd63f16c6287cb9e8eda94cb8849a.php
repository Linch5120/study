	...
	<form action="<?php echo U('/Admin/Blog/index');?>" method="POST">
	    <table class="table table-hover">
	        ...
	        <tr>
	            ...
	            <td><img src="/thinkphp/shop/Public/<?php echo ($v["blog_small_img"]); ?>" width="25px" height="25px"></td>
	            <td><?php echo ($v["title"]); ?></td>
				<td><?php echo (msubstr($v["content"],0,10,'utf-8',true)); ?></td>
				<td><?php echo ($v["cat"]); ?></td>
				<td><img src="/thinkphp/shop/Public/<?php echo ($v["author_img"]); ?>" width="25px" height="25px">&nbsp;&nbsp;<?php echo ($v["author"]); ?></td>
